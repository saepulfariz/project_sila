...
class AssetKategori extends BaseController
{
    /**
     ...
     */
    private $model;
    private $link = 'asset/kategori';
    private $view = 'asset/kategori';
    private $title = 'Asset Kategori';
    public function __construct()
    {
        $this->model = new \App\Models\AssetKategoriModel();
    }
