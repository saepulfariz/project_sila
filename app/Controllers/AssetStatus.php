...
class AssetStatus extends BaseController
{
    /**
     ...
     */
    private $model;
    private $link = 'asset/status';
    private $view = 'asset/status';
    private $title = 'Asset Status';
    public function __construct()
    {
        $this->model = new \App\Models\AssetStatusModel();
    }
