              ...
              <tbody>
                ...
                foreach ($data as $d) : ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-warning btn-sm mb-2" href="<?= base_url($link . '/' . $d['id_kategori'] . '/edit'); ?>">Edit</a>
                      <form action='<?= base_url($link . '') . '/' . $d['id_kategori']; ?>' method='post' enctype='multipart/form-data'>
